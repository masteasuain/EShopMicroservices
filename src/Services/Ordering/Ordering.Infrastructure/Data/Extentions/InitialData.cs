...
internal class InitialData
{
    ...
    public static IEnumerable<Product> Products =>
        new List<Product>
        {
            Product.Create(ProductId.Of(new Guid("5334c966-8457-4cf0-815c-ed2b77c4ff61")), "I Phone X", 500),
    ...
    { 
        get
        {
            ...
            order1.Add(ProductId.Of(new Guid("5334c966-8457-4cf0-815c-ed2b77c4ff61")), 2, 500);
